...
OpenLayers.Control.Panel = OpenLayers.Class(OpenLayers.Control, {
    ...
    addControls: function(controls) {
        ...
        for (var i=0, len=controls.length; i<len; i++) {
            ...
            this.addButtonChildClass(element);
    ...
    /**
     * Method: addButtonChildClass
     * Internal use only.
     *
     * Parameters:
     * element - {DOMElement}
     */
    addButtonChildClass: function (element) {
        for (var i = 0, len = element.childNodes.length; i < len; i++) {
            var child = element.childNodes[i];
            OpenLayers.Element.addClass(child, "olButtonChild");
            this.addButtonChildClass(child);
        }
    },
